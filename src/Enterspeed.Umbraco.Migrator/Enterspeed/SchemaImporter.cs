...
namespace Enterspeed.Umbraco.Migrator.Enterspeed
{
    public class SchemaImporter : ISchemaImporter
    {
            ...
            DocumentTypes documentTypes)
        {
            ...
            {
                throw new NullReferenceException("pageDocType view property not found on schema " +
                                                 JsonSerializer.Serialize(pageDocType));
            }
            ...
            {
                throw new NullReferenceException("document type property not found on schema " +
                                                 JsonSerializer.Serialize(pageDocType));
            }
            ...
            {
                throw new NullReferenceException("alias or name property not found on schema " +
                                                 JsonSerializer.Serialize(pageDocType));
            }
